...
describe("POST /organizations", function () {
     ...
     */
    it("can be created correctly", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var organization;
        return __generator(this, function (_a) {
            ...
            expect(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, organization.save()];
...
describe("GET /organizations", function () {
    ...
    it("can be created correctly", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, organization_1.Organization.find({})];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            }); }); }).not.toThrow();
            done();
...
describe("DELETE /organizations/:id ", function () {
    ...
    it("can be created correctly", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, organization_1.Organization.findByIdAndRemove()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            }); }); }).not.toThrow();
            done();
...
describe("PUT /organizations/:id ", function () {
    /**
     * Tests that a valid product can be created through the productService without throwing any errors.
     */
    it("can be created correctly", function (done) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, organization_1.Organization.findByIdAndUpdate()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            }); }); }).not.toThrow();
            done();
